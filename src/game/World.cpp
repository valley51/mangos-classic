...
void World::LoadConfigSettings(bool reload)
{
	...
	setConfigPos(CONFIG_FLOAT_RATE_XP_KILL_PREMIUM, "Rate.XP.Kill.Premium", 1.0f);
	setConfigPos(CONFIG_FLOAT_RATE_XP_QUEST_PREMIUM, "Rate.XP.Quest.Premium", 1.0f);
	setConfigPos(CONFIG_FLOAT_RATE_XP_EXPLORE_PREMIUM, "Rate.XP.Explore.Premium", 1.0f);
